      ...
      renderContent (h, { node, data, store }) {
        if (node.level > 1) {
          if (node.data.children) {
            return (<div style=""><i class="repair-i-svg-color i-svg-color-parent"><svg-icon icon-class="wis_weixiugenzongin1"></svg-icon></i><span>{ data.topicName }</span></div>)
          } else {
            return (<div><i class="repair-i-svg-color i-svg-color-child"><svg-icon icon-class="wis_weixiugenzongin2"></svg-icon></i><span>{ data.topicName }</span></div>)
          }
        } else {
          return (<div style=""><i class="repair-i-svg-color i-svg-color-parent"><svg-icon icon-class="wis_weixiugenzongin1"></svg-icon></i><span>{ data.topicName }</span></div>)
        }
