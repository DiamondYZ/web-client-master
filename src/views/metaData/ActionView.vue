...
<div class="meta-data">
  <toolbar>
    <toolbar-group>
      <el-button type="border-orange" @click="showAddDialog" :disabled="!owner">新增</el-button>
      <el-button type="border-orange" @click="showCloneDialog" :disabled="!owner || selection.length <= 0">复制</el-button>
    </toolbar-group>
...
<script>
  ...
  import {add, remove, cloneClass} from '@/api/metaData'
